...
import hust.idc.util.matrix.HashSymmetricMatrix;
...
public class TestHashSymmetricMatrix extends TestMatrix {
	...
	public static void main(String[] args) {
		...
		Matrix<Integer, Integer, Integer> matrix = new HashSymmetricMatrix<Integer, Integer>();
		...
		printMatrix(((HashSymmetricMatrix<Integer, Integer>) matrix).clone());
