...
import hust.idc.util.matrix.LinkedMatrix;
...
public class TestLinkedMatrix extends TestMatrix {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Matrix<Integer, Integer, Integer> matrix = new LinkedMatrix<Integer, Integer, Integer>();
