...
import hust.idc.util.matrix.concurrent.ConcurrentHashMatrix;

import java.io.IOException;
import java.util.Iterator;
import java.util.Map;

public class TestConcurrentHashMatrix extends TestMatrix {
	
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Matrix<Integer, Integer, Integer> matrix = new ConcurrentHashMatrix<Integer, Integer, Integer>();
		...
		System.out.println("Reconstruct Matrix by Serialization: ");
		try {
			printMatrix(matrix = reconstructBySerialization(matrix));
