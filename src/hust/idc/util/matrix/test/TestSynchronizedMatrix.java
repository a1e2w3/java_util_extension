...
import hust.idc.util.matrix.Matrixs;
import hust.idc.util.matrix.Matrix.Entry;

import java.util.Iterator;
import java.util.Map;

public class TestSynchronizedMatrix extends TestMatrix {
	...
	public static void main(String[] args) {
		...
		Matrix<Integer, Integer, Integer> matrix = Matrixs.synchronizedMatrix(new ArrayMatrix<Integer, Integer, Integer>());
